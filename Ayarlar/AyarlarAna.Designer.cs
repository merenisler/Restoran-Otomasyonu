namespace PizzaciSon1.Ayarlar
{
    partial class AyarlarAna
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnMasaEkleKaldir.Location = new Point(182, 332);
            ...
            // btnIndırım
            // 
            btnIndırım.BackColor = Color.MediumPurple;
            btnIndırım.FlatAppearance.BorderSize = 0;
            btnIndırım.FlatStyle = FlatStyle.Flat;
            btnIndırım.Font = new Font("Microsoft Sans Serif", 27F, FontStyle.Regular, GraphicsUnit.Point);
            btnIndırım.ForeColor = Color.Black;
            btnIndırım.ImageAlign = ContentAlignment.MiddleLeft;
            btnIndırım.ImageIndex = 0;
            btnIndırım.Location = new Point(733, 332);
            btnIndırım.Name = "btnIndırım";
            btnIndırım.Size = new Size(370, 140);
            btnIndırım.TabIndex = 49;
            btnIndırım.Text = "İndirim Kodu Ekle/Kaldır/Düzenle";
            btnIndırım.UseVisualStyleBackColor = false;
            btnIndırım.Click += btnIndırım_Click;
            // 
            // AyarlarAna
            // 
